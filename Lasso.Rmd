...
We take p and r large, useless varaibles will be removed with the lasso
```{r}
p = 13
r =12
alpha = 1
...
Lasso_fit <- Lasso_function(p = p, r = r, alpha = alpha, variable = variable,remove = remove, plot = TRUE, residuals = FALSE)

print(Lasso_fit$lambda)
print((log(nb_N-2)/nb_T)^(1/2))
...
```{r}
residual <- Lasso_function(p = p, r = r, alpha = alpha, variable = variable,remove = remove, plot = FALSE, residuals = TRUE)
sigma <- sd(residual)
```
